...
void ParticleRenderSystem::m_createPipeline(Device& device, VkRenderPass render_pass, VkDescriptorSetLayout compute_UBO_layout, VkDescriptorSetLayout render_UBO_layout) {
    {
...
ParticleRenderSystem::ParticleRenderSystem(Device& device, VkRenderPass render_pass, VkDescriptorSetLayout global_compute_layout, VkDescriptorSetLayout global_render_layout, float aspect) : m_device(device) {
