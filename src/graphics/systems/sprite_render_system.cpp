...
namespace emp {
    ...
    SpriteRenderSystem::SpriteRenderSystem(Device &device, VkRenderPass renderPass, VkDescriptorSetLayout globalSetLayout, const char* vert_filename, const char* frag_filename) 
            : device{device} {
    ...
    void SpriteRenderSystem::createPipelineLayout(VkDescriptorSetLayout globalSetLayout, size_t push_const_size) {
    ...
    void SpriteRenderSystem::createPipeline(VkRenderPass renderPass, const char* vert_filename, const char* frag_filename) {
    ...
    void SpriteRenderSystem::render(FrameInfo &frameInfo, SpriteSystem& model_sys) {
        ...
        vkCmdBindDescriptorSets(frameInfo.commandBuffer, VK_PIPELINE_BIND_POINT_GRAPHICS, pipeline_layout, 0, 1,
