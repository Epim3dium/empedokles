...
struct HelpCommand : public Console::Command {
    ...
    HelpCommand(Console* cons) : console(cons) {}
};
...
bool InputText(const char* label, std::string& str, ImGuiInputTextFlags flags = 0, ImGuiInputTextCallback callback = 0, void* user_data = nullptr)
{
...
void Console::registerCallbacks() {
    m_callbacks[ImGuiInputTextFlags_CallbackCompletion] = 
    ...
    m_callbacks[ImGuiInputTextFlags_CallbackHistory] = 
        [&](ImGuiInputTextCallbackData* data)->int {
